...
use crate::{
    ...
    colorful_triangle::triangle_vertex::{Vertex, VertexBase},
    camera::uniform_buffer::CameraUniform
};

use super::camera::Camera;

pub struct VertexWithCameraRenderState<'a> {
...
impl<'a> StateBase<'a> for VertexWithCameraRenderState<'a> {
    async fn new(window: &'a winit::window::Window) -> Self {
        ...
        let camera_bindgroup_lauout = device.create_bind_group_layout(
        ...
        let camera_bind_group = device.create_bind_group(
            &wgpu::BindGroupDescriptor { 
                ...
                layout: &camera_bindgroup_lauout,
                entries: &[
                    wgpu::BindGroupEntry {
                        binding: 0,
        ...
        let render_pipeline_layout = device.create_pipeline_layout(
            &wgpu::PipelineLayoutDescriptor { 
                ...
                bind_group_layouts: &[&camera_bindgroup_lauout],
